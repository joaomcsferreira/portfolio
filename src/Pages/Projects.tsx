...
import styledComponents from "../assets/svgs/styledComponents.svg"
          ...
          <div className="grid gap-3 rounded-lg md:grid-cols-projects">
            ...
            <div className="flex flex-col gap-10 text-center justify-self-end w-full p-5">
              ...
              <div className="flex gap-5 justify-center">
                ...
                <a
                  href="https://pinterest-clone-joaoferreira.vercel.app/"
                  target="_blank"
                >
                  <svg
                    className="fill-gainsboro h-14 cursor-pointer md:h-10 hover:fill-white"
          ...
          <div className="grid gap-3 rounded-lg md:grid-cols-projects">
            ...
            <div className="flex flex-col gap-10 text-center justify-self-end w-full p-5">
              ...
              <div className="flex gap-5 justify-center">
                ...
                <a
                  href="https://pokedex-joaoferreira.vercel.app"
                  target="_blank"
                >
                  <svg
                    className="fill-gainsboro h-14 cursor-pointer md:h-10 hover:fill-white"
          ...
          <div className="grid gap-3 rounded-lg md:grid-cols-projects">
            ...
            <div className="flex flex-col gap-10 text-center justify-self-end w-full p-5">
              ...
              <div className="flex gap-5 justify-center">
                ...
                <a
                  href="https://spotify-clone-joaoferreira.vercel.app/"
                  target="_blank"
                >
                  <svg
                    className="fill-gainsboro h-14 cursor-pointer md:h-10 hover:fill-white"
